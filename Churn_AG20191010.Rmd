...
# To run it requiere to have installed:
# 1. R
# 2. Rstudio
# 3. If you are using mac, mactex to do Knit in markdown.
# 4. install.packages("rmarkdown") 

#if you need more information you could check https://medium.com/@sorenlind/create-pdf-reports-using-r-r-markdown-latex-and-knitr-on-macos-high-sierra-e7b5705c9fd
...
### Method 4, monthly charges effect
